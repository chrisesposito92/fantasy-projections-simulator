...
- Recency weighting: `season_weights` parameter on all preprocessor methods for biasing toward recent seasons
...
- Pipeline integration: `penalty_rates` added to pipeline output, `season_weights` passed through
