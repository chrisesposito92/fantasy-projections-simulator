...
**Unified Validation Harness** — Complete

- `scripts/validate.py` is the current validation entrypoint for both total-lift and marginal-lift A/B runs
- Supports `--baseline bare` and `--baseline defaults`
