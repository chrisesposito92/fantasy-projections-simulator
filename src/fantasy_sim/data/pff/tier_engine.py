...
class TierEngine:
    ...
    def _blend_player(
        ...
        # --- Scalar blending ---
        # QBs only get fumble_rate blended.  All other QB fields are either
        # irrelevant (target_share, air_yards_share, catch_rate are
        # receiver/rusher concepts) or carefully calibrated by player_builder
        # (carry_share separates designed runs from scrambles, scramble_rate
        # uses the qb_scramble column).  Tier pools mix mobile and pocket
        # QBs within the same tier, making yards blending counterproductive.
        ...
        # --- Yards blending: proportional resampling (skip QBs) ---
