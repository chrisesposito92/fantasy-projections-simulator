...
- [x] HIGH-3 (snapshot label timing-honesty) resolved (Cycle 1 partially; Cycle 3 fully): labels renamed `open_*` → `prior_*` across CONTEXT, VALIDATION, Plan 09. **Cycle 3:** `01-RESEARCH.md` reconciled — Pattern 5 + Example 3 + bash example bash blocks all use `prior_*`; stale `open_*` and "Tuesday 12pm ET" wording removed.
